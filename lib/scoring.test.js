...
ok('fundamentals = emissions alone when no tvlRev (market-only)', near(scoreFundamentals(null, 9, 'none'), 9));
...
console.log('\nbuildReading');
{
  ...
  ok('B: fundamentals = emissions alone', b.score_fundamentals === b.score_emissions);
